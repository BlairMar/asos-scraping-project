...
class AsosScraper:
     ...
     def load_more_products(self): 
         ...
         self.product_urls = list_all_products
         return len(list_all_products) # save the list with hrefs in another variable that will be reffered to in the following methods
        ...
        try: #find details info
            for key in xpath_dict:
                if key == 'Product Details':
                    ...
                    for nr,detail in details_container:
...
if __name__ == '__main__':
    ...
    # product_search.extract_links('//*[@id="plp"]/div/div/div[2]/div/div[1]/section[1]/article')
    product_search.test_extract_links()