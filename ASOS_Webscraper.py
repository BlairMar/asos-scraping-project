...
class AsosScraper:
     ...
     def click_buttons(self, button_xpath, n_clicks: int ): # n_clicks is the number of clicks
        ...
        '''
        Keyword Arguments: 
        button_xpath: A string which determines the location of the button
     ...
     def choose_category(self,value:int):
        ...
        """Method to choose the category, men or women and other subcategories on the page"""

        '''
        Keyword Arguments: 

        value: integer. 1 scrapes men and 2 scrapes women
     ...
     def _load_more_products(self): 
         ...
         """Method to extract the hrefs from all products"""
         ...
         Returns
         int = a length of the list of product_urls scraped
         '''
