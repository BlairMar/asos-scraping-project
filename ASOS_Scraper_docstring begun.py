...
class AsosScraper:
    ...
    def _get_gender_hrefs(self):
        """
        Returns a list of URL's for webpages to be scraped.
        """
    ...
    def primary_method(self):
        """
        Method to iterate through a list of URL's.
        For each URL; calls protected methods to load more items and scape data and images for every item on each of the pages visted.
        """
    ...
    def _extract_links(self, xpath: str):
        """
        Function to create a list of URL's from a container xpath.

        Parameters: 
            xpath: Requires an xpath string input.
    ...
    def click_buttons(self, button_xpath, n_clicks: int ): # n_clicks is the number of clicks 
        """
        Function to click buttons on webpages.

        Parameters: 
            button_xpath: Requires a clickable website button xpath as a string.
            n_clicks: Number of times the button will be clicked 
    ...
    def _choose_category(self, xpath:str):
         """
         Method to return URL's of webpages to be scraped, for each gender section of website.

        Parameter: 
            xpath: Requires an xpath string input for either the 'Men' or 'Women' sections of the website.
            This xpath is determined within by the '_get_gender_hrefs' method.

        Returns:
            Subcategory URL's for the given gender section of website.
        """
